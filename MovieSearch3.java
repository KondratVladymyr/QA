...
public class MovieSearch {
    ...
    static String undef() {
        ...
        WebElement directorName = new WebDriverWait(driver, Duration.ofSeconds(30))
                .until(elementToBeClickable(By.id("api_director")));
        String b = "assertion passed";
        String c = "assertion failed";
        String[] a = {filmTitle.getText().substring(11), directorName.getText().substring(10)
                , filmYear.getText().substring(6)};
        for (int i = 0; i < a.length - 1; i++)
            if (a[i].equals("undefined")) {
                return b;
            }
        return c;
    }
